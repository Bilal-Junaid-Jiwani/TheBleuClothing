...
const MissionPeople = () => {
    return (
        <section id="mission" className="bg-gray-900 text-white py-24 border-t border-white/10">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">

                    {/* Mission Section */}
                    <div>
                        <h2 className="text-4xl font-black uppercase tracking-tighter mb-12 flex items-center">
                        ...
                        <div className="space-y-12">
                            <div className="group">
                                <h3 className="text-2xl font-bold uppercase mb-4 text-blue-500 group-hover:text-white transition-colors">
                                    Research & Development
                                </h3>
                                <p className="text-gray-400 font-mono leading-relaxed border-l-2 border-white/10 pl-6 group-hover:border-blue-600 transition-colors">
                    ...
                    {/* People Section */}
                    <div className="bg-black p-8 md:p-12 border border-white/10 relative overflow-hidden">
                        {/* Decorative Background Element */}
                        <div className="absolute top-0 right-0 w-32 h-32 bg-blue-600/10 rounded-full blur-3xl"></div>

                        <h2 className="text-4xl font-black uppercase tracking-tighter mb-12 flex items-center relative z-10">
